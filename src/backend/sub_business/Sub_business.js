...
var Sub_business = {
  ...
  createsub_business: function(sub_business, callback) {
    return db.query(
      "Insert into sub_business(sub_business_id, name) values(?, ?)",
  ...
  updatesub_business: function(sub_business,callback){
    return db.query(
      "Update sub_business set name=? where sub_business_id=?",   [sub_business.name, sub_business.id],
      callback,
    );
  },
  ...
  deletesub_business: function(id,callback){
    return db.query(
      "Delete from sub_business where sub_business_id=?", [id],
      callback,
    );
  }
};
